...
'''
'pT_muons', 'eta_muons',  'phi_muons', #these might be LHEParticles?
'PF_hcalFraction'
'''
varList = [
...
d_encoding = {
    'PFCands_charge':{-1.0: 0, 0.0: 1, 1.0: 2},
    'PFCands_pdgId':{-211.0: 0, -13.0: 1, -11.0: 2, 0.0: 3, 1.0: 4, 2.0: 5, 11.0: 6, 13.0: 7, 22.0: 8, 130.0: 9, 211.0: 10},
    'PFCands_fromPV':{0.0: 0, 1.0: 1, 2.0: 2, 3.0: 3}
}
...
for e in progressbar.progressbar(range(maxEntries), widgets=widgets):
    ...
    for j in range(tree['nPFCands'][e]):
        ...
        # encoding
        pf[11] = d_encoding['PFCands_pdgId'][float(tree['PFCands_pdgId'][e][j])]
        pf[12] = d_encoding['PFCands_charge'][float(tree['PFCands_charge'][e][j])]
        pf[13] = d_encoding['PFCands_fromPV'][float(tree['PFCands_fromPV'][e][j])]
